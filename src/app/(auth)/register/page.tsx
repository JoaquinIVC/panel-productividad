    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-950 via-gray-900 to-indigo-950 px-4">
        <motion.div
          ...
          className="w-full max-w-md bg-gray-900/80 backdrop-blur-xl border border-gray-800 rounded-2xl p-8 shadow-2xl text-center"
        >
          ...
          <Link
            href="/login"
            className="inline-flex py-3 px-6 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold hover:from-indigo-500 hover:to-purple-500 transition-all shadow-lg shadow-indigo-500/25"
          >
            Ir al Login
          </Link>
        </motion.div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-950 via-gray-900 to-indigo-950 px-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2">Empieza a gestionar tu productividad</p>
        </div>
        ...
        <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-800 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-gray-900 px-3 text-gray-500">o continuar con</span>
            </div>
          </div>

          <button
            onClick={handleGitHubLogin}
            className="w-full py-3 px-4 rounded-xl bg-gray-800 border border-gray-700 text-white font-medium hover:bg-gray-750 hover:border-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all flex items-center justify-center gap-3"
          >
